...
const FilterModal = ({selectedFilters, onFilterChange, onClose}) => {
    ...
    const handleFilterChange= () => {
        ...
        onFilterChange("properType", propertyType)
    ...
    //Fuction to handle clearing filters
    ...
    //Function to handle changes in property 
        ...
        <div className='modal-content'>
            ...
            <div className='modal-filters-container'>
                ...
                <div className='filter-buttons'>
                    <button className='clear-button' onClick={handleClearFliters}>Clear</button>
...
FilterModal.propTypes = {
    ...
    onCloseL: PropTypes.func.isRequired
}
